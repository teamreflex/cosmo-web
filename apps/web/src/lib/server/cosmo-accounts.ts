 ...
 */
export const fetchFullAccount = createServerOnlyFn(
  async (identifier: string): Promise<FullAccount | undefined> => {
 ...
 */
export const linkAccount = createServerOnlyFn(
  async (account: Omit<CosmoAccount, "id">) => {
 ...
 */
export const cacheAccounts = createServerOnlyFn(
  async (accounts: PartialAccount[]) => {
