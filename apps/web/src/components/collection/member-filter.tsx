...
function ArtistPopoverContent(props: ArtistPopoverContentProps) {
  ...
  return (
    <PopoverContent
      ...
      className="z-20 no-scrollbar flex w-fit max-w-[95vw] flex-row items-center justify-items-start gap-2 overflow-x-scroll rounded-lg border-transparent bg-(--artist-color/0.15) px-2 py-1 backdrop-blur-[30px] backdrop-brightness-[1.3] backdrop-saturate-160 xl:justify-center"
    >
