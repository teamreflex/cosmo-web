...
function Row(props: RowProps) {
  ...
  return (
    <div className="flex h-12 w-full items-center gap-4 rounded-lg bg-secondary/70 px-4 transition-all hover:bg-secondary">
      <div className="flex flex-col">
        <span className="truncate text-sm font-semibold">{nickname}</span>
        {candidate !== undefined ? (
