              ...
              <AlertDialogDescription asChild>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p>
                      Locking an objekt hides the send button, allowing you to
                      mark anything you don&apos;t want to accidentally send or
                      to indicate to other people that it is not up for trade.
                    </p>
                    <p>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p>
                      Different indicators in the top left denote different
                      statuses of an objekt.
                    </p>
